...
.org 0x40DF78         ;能力传送坐标的基础数据
; 起始区 始X坐标x2 始Y坐标x2  ??  终区 终X  终Y   ??   0000
.db 0x00,0x09,0x09,0x0F,0x0F,0x01,0x05,0x0A,0x07,0x01,0x00,0x00 ;长枪指引数据
...
.dh 0x0D40,0x0AC0,0x11C0    ;峡谷数据起始
.dh 0x0B40,0x0F40,0x10C0    ;母舰数据起始
.dh 0x0040
