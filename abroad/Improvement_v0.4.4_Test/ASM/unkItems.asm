...
;-------
; Items (Modified for sm style item grabbing) [INCOMPLETE/BROKEN]
;-------
; display correct text
;.org 0x801B84C
;	bl      SwitchText
...
;    mov r0,0x3A
;.org 0x801B898        ; Play correct ability jingle
;    mov r0,0x3A        ;
;.org 0x801B8CC        ; Play sound routine (Prevents music from cutting off)
;    bl 0x8002A18    ;
;.org 0x801B89C        ; Fast skip First tank
;    b 0x801B8BC        ;
;.org 0x801B910        ;
