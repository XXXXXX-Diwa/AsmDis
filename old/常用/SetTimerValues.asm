.gba
.open "zm.gba","RewittenTimers.gba",0x8000000
...
;uses no freespace. Replaces original function
.org 0x8053AA8
	push	r4-r6,r14
...
;normal mode timer values for timer 1 (MB in vanilla)
	mov		r1,3h						;minutes tens place
	mov		r2,3h						;minutes ones place
	mov		r3,4h						;seconds tens place
	mov		r4,5h						;seconds ones place
	mov		r5,1h						;tenths of second
	mov		r6,3h						;hundredths of second
	b		@@StoreValues
@@HardValues:
