...
;one of the routines used to deal with damage dealt to a sprite. Does not run when an ice projectile, Power Bombs,
;screw attack, or speedbooster damages the sprite. 


.org 0x8050424 			;r0 = sprite data pointer, r1 = damage to be dealt
	push    r4-r6,r14                           
...
@@ReturnValue:
 	mov     r1,r3		;moves sprite data pointer to r1                             
   	add     r1,24h          ;adds 24, sprite pose                       
   	...
   	strb    r0,[r1]		;stores 1 to 26 of Sprite Data                               
    	add     r0,r6,1                             
    	lsl     r0,r0,18h                          
    	lsr     r6,r0,18h       ;gets return value                       
@@Stun:    
	mov     r2,r3		;moves sprite data pointer to r2                                 
   	...
   	mov     r0,r6                                
    	pop     r4-r6                     
    	pop     r1                                      
	bx	r1		;r0 returns 1 if sprite is dead
.pool
.close