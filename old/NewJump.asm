.gba
.open "zm.gba","NewJump.gba",0x8000000
...
.definelabel CheckAnimation2,800FBC8h
.definelabel CheckAnimation,800FC00h
...
.definelabel FallCheckBlock,800F47Ch
.definelabel CheckBlock2,800F688h
.definelabel CloseDoorFlag,300007Bh
.definelabel SpritesDateRAMStart,3000738h
...
.definelabel Random4BitNumber,300083Ch
...
@@NoFloor:
     ...
     b @@Peer2
@@Peer:
     bl CheckAnimation       ;CheckAnimation OAM 8310464h
     cmp r0,0h
     beq @@end
	 mov r0,0Ah
