...
.org 0x8760D50			; change to freespace
	...
	mov r6,0CBh		;Change X to any combinations of values according to the Suit/Misc table above. For example, 60h gives you Gravity and morphball
	strb r6,[r5,0Eh]	;Stores X to aquired Suit/Misc Items
	strb r6,[r5,0Fh]	;Stores X to equipped Suit/Misc Items
	mov r6,09Ah		;Change Y to any combination of values according to the Beams/Bombs table. For example, 98h gives you Bombs, Charge Beam , and Plasma
	strb r6,[r5,0Ch]	;Stores Y to aquired Beams/Bombs
	strb r6,[r5,0Dh]	;Stores Y to equipped Beams/Bombs
	mov r6,0h		;Change Z to the number of missiles you'd like to start with. For example, 0Ah is 10 missiles.
	strh r6,[r5,2h]		;Stores Z to max Missiles
	strh r6,[r5,8h]		;Stores Z to current Missiles
	mov r6,32h		;Change N to number of supers you'd like to start with. For example 0Ah is 10 Super Missiles.
	strb r6,[r5,4h]		;Stores N to max Super Missiles
	strb r6,[r5,0Ah]		;Stores N to current Super Missiles
	mov r6,0h		;Change V to the number of Power Bombs you'd like to start with. For example 0Ah is 10 Power Bombs
	strb r6,[r5,5h]		;Stores V to Max Power Bombs
	strb r6,[r5,0Bh]		;Stores V to Current Power Bombs
	mov r6,0h		;Change W to type of Suit you'd like to start with
