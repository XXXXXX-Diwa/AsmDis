...
080130F8 7008     strb    r0,[r1]        ;300075a写入3h                         
...
0801B6C2 8008     strh    r0,[r1]      ;3001606写入3e8h                               
...
0801B72E 80D0     strh    r0,[r2,6h]   ;弹丸Y坐标写入9h                          
0801B730 4660     mov     r0,r12                                  
0801B732 302C     add     r0,2Ch                                  
0801B734 2101     mov     r1,1h                                   
0801B736 7001     strb    r1,[r0]      ;3000764写入1h                             
0801B738 3002     add     r0,2h                                   
0801B73A 7004     strb    r4,[r0]      ;3000766写入0h                           
0801B73C 2E16     cmp     r6,16h                                  
0801B73E D10B     bne     @@spawntimezero                                
0801B740 3801     sub     r0,1h                                   
0801B742 7001     strb    r1,[r0]     ;3000765生产时间写入1h                            
...
0801B764 7801     ldrb    r1,[r0]     ;读取30006ec的值 精灵串ID                            
0801B766 1C04     mov     r4,r0                                   
0801B768 2911     cmp     r1,11h                                  
0801B76A D105     bne     @@IDNO11                                
...
0801B788 D1F6     bne     @@IDNO11    ;检查所有的ID都不是11h                            
0801B78A 4806     ldr     r0,=30006FBh                            
0801B78C 1810     add     r0,r2,r0 

@@ID11:                               
0801B78E 7803     ldrb    r3,[r0] 

@@AllIDNO11:                                
0801B790 2B07     cmp     r3,7h     ;除非ID = 11 否则都大于                                
0801B792 D809     bhi     @@IDNO11Away                                
...
0801B7D6 88C8     ldrh    r0,[r1,6h]  ;弹丸Y坐标减1再写入 原本写入了9h                           
...
0801B838 7FA5     ldrb    r5,[r4,1Eh]  ;读取3000756的值   10h?                        
0801B83A 46A8     mov     r8,r5                                   
0801B83C 1C27     mov     r7,r4                                   
0801B83E 372C     add     r7,2Ch                                  
0801B840 783E     ldrb    r6,[r7]      ;读取3000764的值  1h?                           
0801B842 2E00     cmp     r6,0h                                   
0801B844 D06E     beq     @@764is0                                
...
0801B858 7038     strb    r0,[r7]   ;3000764写入0                              
0801B85A 8821     ldrh    r1,[r4]                                 
0801B85C 480D     ldr     r0,=0FFFBh                              
0801B85E 4008     and     r0,r1     ;FFFBh and 取向                              
0801B860 8020     strh    r0,[r4]                                 
0801B862 1C28     mov     r0,r5     ;10h                              
...
0801B874 7008     strb    r0,[r1]  ;3000766写入1h                               
...
@@UNknowItem:                                
0801B886 2042     mov     r0,42h                                  
0801B888 E01F     b       @@goto                                

@@Abilitysound:                                
0801B898 2037     mov     r0,37h                                  
...
0801B8FC 2900     cmp     r1,0h     ;3000766不为0跳转                              
0801B8FE D107     bne     @@message                                
0801B900 4640     mov     r0,r8     ;10h?                              
...
0801B980 F7F2FC6A bl      800E258h                                
0801B984 E00A     b       @@end                                
0801B986 0000     lsl     r0,r0,0h                                
0801B988 BABC     ????                                            
0801B98A 082C     lsr     r4,r5,20h                               
...
0801B9B0 2A20     cmp     r2,20h                                  
0801B9B2 D107     bne     801B9C4h                                
0801B9B4 4902     ldr     r1,=3001606h                            
0801B9B6 2000     mov     r0,0h                                   
0801B9B8 E008     b       801B9CCh                                
0801B9BA 0000     lsl     r0,r0,0h                                
0801B9BC 0738     lsl     r0,r7,1Ch                               
0801B9BE 0300     lsl     r0,r0,0Ch                               
0801B9C0 1606     asr     r6,r0,18h                               
0801B9C2 0300     lsl     r0,r0,0Ch                               
0801B9C4 4905     ldr     r1,=3001606h                            
0801B9C6 24FA     mov     r4,0FAh                                 
0801B9C8 00A4     lsl     r4,r4,2h                                
0801B9CA 1C20     mov     r0,r4                                   
0801B9CC 8008     strh    r0,[r1]                                 
0801B9CE 1C19     mov     r1,r3                                   
0801B9D0 88C8     ldrh    r0,[r1,6h]                              
0801B9D2 2800     cmp     r0,0h                                   
0801B9D4 D004     beq     801B9E0h                                
0801B9D6 3801     sub     r0,1h                                   
0801B9D8 80C8     strh    r0,[r1,6h]                              
0801B9DA E011     b       801BA00h                                
0801B9DC 1606     asr     r6,r0,18h                               
0801B9DE 0300     lsl     r0,r0,0Ch                               
0801B9E0 2A16     cmp     r2,16h                                  
0801B9E2 D00D     beq     801BA00h                                
0801B9E4 4808     ldr     r0,=300137Ch                            
0801B9E6 8801     ldrh    r1,[r0]                                 
0801B9E8 20F3     mov     r0,0F3h                                 
0801B9EA 4008     and     r0,r1                                   
0801B9EC 2800     cmp     r0,0h                                   
0801B9EE D103     bne     801B9F8h                                
0801B9F0 4806     ldr     r0,=30013D2h                            
0801B9F2 7800     ldrb    r0,[r0]                                 
0801B9F4 2800     cmp     r0,0h                                   
0801B9F6 D003     beq     801BA00h                                
0801B9F8 1C19     mov     r1,r3                                   
0801B9FA 3124     add     r1,24h                                  
0801B9FC 2024     mov     r0,24h                                  
0801B9FE 7008     strb    r0,[r1]                                 
0801BA00 BC10     pop     r4                                      
0801BA02 BC01     pop     r0                                      
0801BA04 4700     bx      r0                                      
0801BA06 0000     lsl     r0,r0,0h                                
0801BA08 137C     asr     r4,r7,0Dh                               
0801BA0A 0300     lsl     r0,r0,0Ch                               
0801BA0C 13D2     asr     r2,r2,0Fh                               
0801BA0E 0300     lsl     r0,r0,0Ch                               
0801BA10 B500     push    r14                                     
0801BA12 4808     ldr     r0,=3000044h                            
0801BA14 7800     ldrb    r0,[r0]                                 
0801BA16 0600     lsl     r0,r0,18h                               
0801BA18 1600     asr     r0,r0,18h                               
0801BA1A 2800     cmp     r0,0h                                   
0801BA1C D001     beq     801BA22h                                
0801BA1E F03FF9B5 bl      805AD8Ch                                
...
0801BA2C D10A     bne     801BA44h                                
0801BA2E 4804     ldr     r0,=82CBB14h                            
0801BA30 E009     b       801BA46h                                
0801BA32 0000     lsl     r0,r0,0h                                
0801BA34 0044     lsl     r4,r0,1h                                
0801BA36 0300     lsl     r0,r0,0Ch                               
0801BA38 0738     lsl     r0,r7,1Ch                               
0801BA3A 0300     lsl     r0,r0,0Ch                               
0801BA3C BB5C     ????                                            
0801BA3E 082C     lsr     r4,r5,20h                               
0801BA40 BB14     ????                                            
0801BA42 082C     lsr     r4,r5,20h                               
...
0801BA54 7008     strb    r0,[r1]                                 
0801BA56 BC01     pop     r0                                      
0801BA58 4700     bx      r0                                      
0801BA5A 0000     lsl     r0,r0,0h                                
0801BA5C BA64     ????                                            
0801BA5E 082C     lsr     r4,r5,20h                               
...
0801BA6E 2800     cmp     r0,0h                                   
0801BA70 D046     beq     801BB00h                                
0801BA72 2700     mov     r7,0h                                   
0801BA74 8037     strh    r7,[r6]                                 
0801BA76 2C17     cmp     r4,17h                                  
0801BA78 D108     bne     801BA8Ch                                
0801BA7A 4903     ldr     r1,=3000049h                            
0801BA7C 2000     mov     r0,0h                                   
0801BA7E 7008     strb    r0,[r1]                                 
0801BA80 E033     b       801BAEAh                                
0801BA82 0000     lsl     r0,r0,0h                                
0801BA84 0738     lsl     r0,r7,1Ch                               
0801BA86 0300     lsl     r0,r0,0Ch                               
0801BA88 0049     lsl     r1,r1,1h                                
0801BA8A 0300     lsl     r0,r0,0Ch                               
0801BA8C 2C20     cmp     r4,20h                                  
0801BA8E D121     bne     801BAD4h                                
...
0801BAC2 F7F2FC2B bl      800E31Ch                                
0801BAC6 E010     b       801BAEAh                                
0801BAC8 070C     lsl     r4,r1,1Ch                               
0801BACA 0300     lsl     r0,r0,0Ch                               
0801BACC 080C     lsr     r4,r1,20h                               
0801BACE 0300     lsl     r0,r0,0Ch                               
0801BAD0 FF00     bl      lr+0E00h                                
0801BAD2 FFFF     bl      lr+0FFEh                                
0801BAD4 1E68     sub     r0,r5,1                                 
0801BAD6 0600     lsl     r0,r0,18h                               
0801BAD8 0E00     lsr     r0,r0,18h                               
0801BADA 2801     cmp     r0,1h                                   
0801BADC D903     bls     801BAE6h                                
0801BADE 2D04     cmp     r5,4h                                   
0801BAE0 D001     beq     801BAE6h                                
0801BAE2 2D06     cmp     r5,6h                                   
0801BAE4 D101     bne     801BAEAh                                
0801BAE6 F7E8FB33 bl      8004150h                                
0801BAEA 4907     ldr     r1,=3001606h                            
0801BAEC 2000     mov     r0,0h                                   
0801BAEE 8008     strh    r0,[r1]                                 
0801BAF0 4806     ldr     r0,=3000738h                            
0801BAF2 302E     add     r0,2Eh                                  
0801BAF4 7800     ldrb    r0,[r0]                                 
0801BAF6 2800     cmp     r0,0h                                   
0801BAF8 D002     beq     801BB00h                                
0801BAFA 4905     ldr     r1,=3000BF0h                            
0801BAFC 2006     mov     r0,6h                                   
0801BAFE 7008     strb    r0,[r1]                                 
