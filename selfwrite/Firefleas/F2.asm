...
@@Loop:	
	...
	lsl		r1,r1,3h			;400h
	add		r1,r3
	add		r1,r1,r5			;5000400h
	ldrh	r2,[r1]				;备份的砖块调色板值
	mov		r0,r2
	lsr		r0,r0,0Ah			;右移十位
	bl      FirefleasControlDark
	lsl		r0,r0,0Ah			;左移10位
	mov		r4,r0
	mov		r0,r2
	lsl		r0,r0,15h			;左移21位
